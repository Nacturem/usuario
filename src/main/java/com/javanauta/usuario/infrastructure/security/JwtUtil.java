...
public class JwtUtil {
    ...
    private final String secretKey = "ICAgc3VhY2hhdmVzZWNyZXRhc3VwZXJzZWd1cmFxdWVkZXZlc2VyYmVtbG9uZ2EK";

    private SecretKey getSecretKey(){
        byte[] key = Base64.getDecoder().decode(secretKey);
        return Keys.hmacShaKeyFor(key);
    }
//https://www.base64decode.org/pt/ site para decoficar base64
